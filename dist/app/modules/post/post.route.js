...
router.post("/create-post", (0, auth_1.default)(user_1.USER_ROLE.ADMIN, user_1.USER_ROLE.AUTHOR, user_1.USER_ROLE.SUPER_ADMIN), fileUploadHelper_1.FileUploadHelper.upload.single("file"), (req, res, next) => {
...
router.patch("/:postId/update-news", (0, auth_1.default)(user_1.USER_ROLE.ADMIN, user_1.USER_ROLE.AUTHOR, user_1.USER_ROLE.SUPER_ADMIN), fileUploadHelper_1.FileUploadHelper.upload.single("file"), (req, res, next) => {
