...
exports.EditorDashboardController = void 0;
...
const getOverview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield editor_service_1.EditorDashboardService.getEditorDashboardOverview(userId);
...
exports.EditorDashboardController = {
    getOverview,
};
